    ...
    public class iDR : Indicator
    {
        ...
        public override void Calculate(int index)
        {
            ...
            if (index == iSeriesCloseCnt)
            {
                ...
                for (int l_index_56 = index - LevelH; l_index_56 < index; l_index_56++)
                {
                    ...
                    if (g_ibuf_160[l_index_56] - g_ibuf_156[l_index_56] != 0.0)
                        g_ibuf_152[l_index_56] = 100.0 * ((MarketSeries.Close[l_index_56] - g_ibuf_156[l_index_56]) / (g_ibuf_160[l_index_56] - g_ibuf_156[l_index_56]));
                    else
                        g_ibuf_152[l_index_56] = 50;

                    if (g_ibuf_160[l_index_56 - 5] - (g_ibuf_156[l_index_56 - 5]) != 0.0)
                        g_ibuf_164[l_index_56] = 100.0 * ((MarketSeries.Close[l_index_56] - (g_ibuf_156[l_index_56 - 5])) / (g_ibuf_160[l_index_56 - 5] - (g_ibuf_156[l_index_56 - 5])));
                    else
                        g_ibuf_164[l_index_56] = 50;
                }

                for (int l_index_56 = index; l_index_56 > index - LevelH; l_index_56--)
                {
                    if (g_ibuf_152[l_index_56] > 10.0 && g_ibuf_152[l_index_56 - 1] <= 10.0)
                        BuySignal[l_index_56] = 50;
                    if (g_ibuf_152[l_index_56] < 90.0 && g_ibuf_152[l_index_56 - 1] >= 90.0)
                        SellSignal[l_index_56] = 50;
                }
            }
        }
        ...
        double MyLinRegr(bool ai_0, double ad_4, double ad_12, double ad_unused_20, int ai_28, int ai_32 = 0)
        {
            ...
            for (int l_index_64 = 0; l_index_64 < Period; l_index_64++)
                lda_52[l_index_64] = ad_4 + ad_12 * l_index_64;
            //--
            for (int l_index_64 = 0; l_index_64 < Period; l_index_64++)
            {
                if (MarketSeries.Close[ai_28 - l_index_64 - ai_32] - lda_52[l_index_64] > ld_36)
                    ld_36 = MarketSeries.Close[ai_28 - l_index_64 - ai_32] - lda_52[l_index_64];
                if (lda_52[l_index_64] - (MarketSeries.Close[ai_28 - l_index_64 - ai_32]) > ld_44)
                    ld_44 = lda_52[l_index_64] - (MarketSeries.Close[ai_28 - l_index_64 - ai_32]);
            }
            //--
            if (ld_36 > ld_44)
            {
