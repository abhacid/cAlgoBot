    ...
    public class MTFCandles_Indicator : Indicator
    {
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (i = Bars - 1 - IndicatorCounted(); i >= 0; i--)
            {
                ...
                {
                    ShortWickUp[shift2] = high;
                    ShortCandleUp[shift2] = bodyHigh;
                    ShortWickDown[shift2] = low;
                    ShortCandleDown[shift2] = bodyLow;
                }
                else if (open >= close && close < EMA_L[i])
                {
                    ShortWickUp[shift2] = low;
                    ShortCandleUp[shift2] = bodyLow;
                    ShortWickDown[shift2] = high;
                    ShortCandleDown[shift2] = bodyHigh;
                }
            }
        ...
        public IndicatorDataSeries ShortWickUp_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries ShortWickDown_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries ShortCandleUp_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries ShortCandleDown_AlgoOutputDataSeries { get; set; }
        ...
        int indicator_color2 = Maroon;
        int indicator_color3 = Red;
        int indicator_color4 = Maroon;
        ...
        private Mq4OutputDataSeries ShortWickUp;
        private Mq4OutputDataSeries ShortWickDown;
        private Mq4OutputDataSeries ShortCandleUp;
        private Mq4OutputDataSeries ShortCandleDown;
        ...
        {
            if (ShortWickUp_AlgoOutputDataSeries == null)
                ShortWickUp_AlgoOutputDataSeries = CreateDataSeries();
            ShortWickUp = new Mq4OutputDataSeries(this, ShortWickUp_AlgoOutputDataSeries, ChartObjects, 2, 0, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(ShortWickUp);
            if (ShortWickDown_AlgoOutputDataSeries == null)
                ShortWickDown_AlgoOutputDataSeries = CreateDataSeries();
            ShortWickDown = new Mq4OutputDataSeries(this, ShortWickDown_AlgoOutputDataSeries, ChartObjects, 2, 1, () => CreateDataSeries(), 1, Colors.Maroon);
            AllBuffers.Add(ShortWickDown);
            if (ShortCandleUp_AlgoOutputDataSeries == null)
                ShortCandleUp_AlgoOutputDataSeries = CreateDataSeries();
            ShortCandleUp = new Mq4OutputDataSeries(this, ShortCandleUp_AlgoOutputDataSeries, ChartObjects, 2, 2, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(ShortCandleUp);
            if (ShortCandleDown_AlgoOutputDataSeries == null)
                ShortCandleDown_AlgoOutputDataSeries = CreateDataSeries();
            ShortCandleDown = new Mq4OutputDataSeries(this, ShortCandleDown_AlgoOutputDataSeries, ChartObjects, 2, 3, () => CreateDataSeries(), 1, Colors.Maroon);
            AllBuffers.Add(ShortCandleDown);
            ...
            AllOutputDataSeries.Add(ShortWickUp_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ShortWickDown_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ShortCandleUp_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ShortCandleDown_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                ShortWickUp.SetCurrentIndex(index);
                ShortWickDown.SetCurrentIndex(index);
                ShortCandleUp.SetCurrentIndex(index);
                ShortCandleDown.SetCurrentIndex(index);
