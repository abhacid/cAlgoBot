...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class Pivot_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
            IndicatorBuffers(4);
        ...
        Mq4Double Mq4Start()
        {
            ...
            if (Period() > 1440)
            {
                Mq4Print("Error - Chart period is_ greater than 1 day.");
                return -1;
            }


            ArrayCopyRates(rates_d1, Symbol.Code, PERIOD_D1);
            ...
            seco = (Time[4] - Time[5]) - MathMod(CurTime(), Time[4] - Time[5]);
            minu = seco / 60;
        ...
        [Parameter("pivots", DefaultValue = true)]
        public bool pivots_parameter { get; set; }
        bool _pivotsGot;
        Mq4Double pivots_backfield;
        Mq4Double pivots
        {
            get
            {
                if (!_pivotsGot)
                    pivots_backfield = pivots_parameter;
                return pivots_backfield;
            }
            set { pivots_backfield = value; }
        }

        [Parameter("camarilla", DefaultValue = false)]
        public bool camarilla_parameter { get; set; }
        bool _camarillaGot;
        Mq4Double camarilla_backfield;
        Mq4Double camarilla
        {
            get
            {
                if (!_camarillaGot)
                    camarilla_backfield = camarilla_parameter;
                return camarilla_backfield;
            }
            set { camarilla_backfield = value; }
        }

        [Parameter("midpivots", DefaultValue = true)]
        public bool midpivots_parameter { get; set; }
        bool _midpivotsGot;
        Mq4Double midpivots_backfield;
        Mq4Double midpivots
        {
            get
            {
                if (!_midpivotsGot)
                    midpivots_backfield = midpivots_parameter;
                return midpivots_backfield;
            }
            set { midpivots_backfield = value; }
        }
        ...
        Mq4DoubleTwoDimensionalArray rates_d1 = new Mq4DoubleTwoDimensionalArray(6);
        Mq4Double D = 0;
        Mq4Double nD = 0;
        Mq4Double nQ = 0;
        Mq4Double L3;
        ...
        Mq4Double Q = 0;
        Mq4Double P = 0;
        Mq4Double today_low = 0;
        Mq4Double today_high = 0;
        Mq4Double today_open = 0;
        Mq4Double yesterday_close = 0;
        Mq4Double yesterday_low = 0;
        Mq4Double yesterday_open = 0;
        Mq4Double yesterday_high = 0;
        Mq4Double day_low = 0;
        Mq4Double day_high = 0;
        ...
        protected override void Initialize()
        {
            ...
            ExtMapBuffer1 = new Mq4OutputDataSeries(this, ExtMapBuffer1_AlgoOutputDataSeries, ChartObjects, 3, 0, () => CreateDataSeries(), 1, Colors.Green);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly Pivot_Indicator _indicator;

            public Mq4OutputDataSeries(Pivot_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = Pivot_Indicator.GetArrowByCode(ArrowCode);
