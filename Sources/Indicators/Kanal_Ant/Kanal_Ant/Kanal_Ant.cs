...
namespace cAlgo.Indicators
{
    ...
    [Levels()]
    public class Kanal_Ant_Indicator : Indicator
    {
        Mq4Double Mq4Init()
        {
            Mq4String short_name = "";
            Mq4Double draw_begin = 0;
            ...
            IndicatorDigits(MarketInfo(Symbol.Code, MODE_DIGITS));
            if (MA_Period < 2)
                MA_Period = 14;
        ...
        [Parameter("BarsCount", DefaultValue = 500)]
        public int BarsCount_parameter { get; set; }
        bool _BarsCountGot;
        Mq4Double BarsCount_backfield;
        Mq4Double BarsCount
        {
            get
            {
                if (!_BarsCountGot)
                    BarsCount_backfield = BarsCount_parameter;
                return BarsCount_backfield;
            }
            set { BarsCount_backfield = value; }
        }

        [Parameter("MA_Period", DefaultValue = 55)]
        ...
        public int MA_Shift_parameter { get; set; }
        bool _MA_ShiftGot;
        ...
        [Parameter("MA_Method", DefaultValue = 0)]
        public int MA_Method_parameter { get; set; }
        bool _MA_MethodGot;
        ...
        public int Applied_Price_parameter { get; set; }
        ...
        [Parameter("fontsize", DefaultValue = 7)]
        public int fontsize_parameter { get; set; }
        bool _fontsizeGot;
        Mq4Double fontsize_backfield;
        Mq4Double fontsize
        {
            get
            {
                if (!_fontsizeGot)
                    fontsize_backfield = fontsize_parameter;
                return fontsize_backfield;
            }
            set { fontsize_backfield = value; }
        }

        [Parameter("Deviation", DefaultValue = 1)]
        public double Deviation_parameter { get; set; }
        bool _DeviationGot;
        Mq4Double Deviation_backfield;
        Mq4Double Deviation
        {
            get
            {
                if (!_DeviationGot)
                    Deviation_backfield = Deviation_parameter;
                return Deviation_backfield;
            }
            set { Deviation_backfield = value; }
        }



        [Output("ExtMapBuffer1", Color = Colors.Green, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer1_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer2", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer2_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer3", Color = Colors.Green, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer3_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer4", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer4_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer5", Color = Colors.Green, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer5_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer6", Color = Colors.Red, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer6_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer7", Color = Colors.Teal, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer7_AlgoOutputDataSeries { get; set; }


        Mq4Double ExtCountedBars = 0;

        int indicator_buffers = 7;
        int indicator_color1 = Green;
        int indicator_color2 = Red;
        int indicator_color3 = Green;
        int indicator_color4 = Red;
        int indicator_color5 = Green;
        int indicator_color6 = Red;
        int indicator_color7 = Teal;
        ...
        private Mq4OutputDataSeries ExtMapBuffer3;
        private Mq4OutputDataSeries ExtMapBuffer4;
        private Mq4OutputDataSeries ExtMapBuffer5;
        private Mq4OutputDataSeries ExtMapBuffer6;
        private Mq4OutputDataSeries ExtMapBuffer7;
        ...
        protected override void Initialize()
        {
            ...
            ExtMapBuffer1 = new Mq4OutputDataSeries(this, ExtMapBuffer1_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 1, Colors.Green);
            ...
            ExtMapBuffer2 = new Mq4OutputDataSeries(this, ExtMapBuffer2_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(ExtMapBuffer2);
            if (ExtMapBuffer3_AlgoOutputDataSeries == null)
                ExtMapBuffer3_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer3 = new Mq4OutputDataSeries(this, ExtMapBuffer3_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 1, Colors.Green);
            AllBuffers.Add(ExtMapBuffer3);
            if (ExtMapBuffer4_AlgoOutputDataSeries == null)
                ExtMapBuffer4_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer4 = new Mq4OutputDataSeries(this, ExtMapBuffer4_AlgoOutputDataSeries, ChartObjects, 0, 3, () => CreateDataSeries(), 1, Colors.Red);
            AllBuffers.Add(ExtMapBuffer4);
            if (ExtMapBuffer5_AlgoOutputDataSeries == null)
                ExtMapBuffer5_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer5 = new Mq4OutputDataSeries(this, ExtMapBuffer5_AlgoOutputDataSeries, ChartObjects, 0, 4, () => CreateDataSeries(), 2, Colors.Green);
            AllBuffers.Add(ExtMapBuffer5);
            if (ExtMapBuffer6_AlgoOutputDataSeries == null)
                ExtMapBuffer6_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer6 = new Mq4OutputDataSeries(this, ExtMapBuffer6_AlgoOutputDataSeries, ChartObjects, 0, 5, () => CreateDataSeries(), 2, Colors.Red);
            AllBuffers.Add(ExtMapBuffer6);
            if (ExtMapBuffer7_AlgoOutputDataSeries == null)
                ExtMapBuffer7_AlgoOutputDataSeries = CreateDataSeries();
            ExtMapBuffer7 = new Mq4OutputDataSeries(this, ExtMapBuffer7_AlgoOutputDataSeries, ChartObjects, 0, 6, () => CreateDataSeries(), 2, Colors.Teal);
            AllBuffers.Add(ExtMapBuffer7);

            AllOutputDataSeries.Add(ExtMapBuffer1_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer2_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer3_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer4_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer5_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer6_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(ExtMapBuffer7_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            try
            {
                ...
                ExtMapBuffer3.SetCurrentIndex(index);
                ExtMapBuffer4.SetCurrentIndex(index);
                ExtMapBuffer5.SetCurrentIndex(index);
                ExtMapBuffer6.SetCurrentIndex(index);
                ExtMapBuffer7.SetCurrentIndex(index);
        ...
        class Mq4OutputDataSeries : IMq4DoubleArray
        {
            ...
            private readonly Kanal_Ant_Indicator _indicator;

            public Mq4OutputDataSeries(Kanal_Ant_Indicator indicator, IndicatorDataSeries outputDataSeries, ChartObjects chartObjects, int style, int bufferIndex, Func<IndicatorDataSeries> dataSeriesFactory, int lineWidth, Colors? color = null)
            {
            ...
            public override void Draw()
            {
                ...
                switch (ArrowCode)
                {
                    ...
                    case SYMBOL_LEFTPRICE:
                        ...
                        break;
                    default:
                        arrowString = Kanal_Ant_Indicator.GetArrowByCode(ArrowCode);
