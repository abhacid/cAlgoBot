...
{
    [Indicator(ScalePrecision = 5, AutoRescale = true, IsOverlay = false, AccessRights = AccessRights.None)]
    [Levels(0, 8, 6, -6, -8)]
    public class ConvertedIndicator : Indicator
    {


        [Output("Open", Color = Colors.Purple, PlotType = PlotType.Points)]
        public IndicatorDataSeries OpenR { get; set; }
        [Output("Close", Color = Colors.Orange, PlotType = PlotType.Points)]
        public IndicatorDataSeries CloseR { get; set; }
        ...
        Mq4Double Mq4Start()
        {
            Mq4Double l_index_36 = 0;
            Mq4Double l_index_40 = 0;
            Mq4Double li_8 = 0;
            Mq4String ls_0 = "";
            Mq4String l_name_52 = "";
            Mq4String l_name_44 = "";
            ...
            if (Year() >= 2050)
                return 0;
            ls_0 = " BELKHAYATE TIMING    ";
            li_8 = WindowFind(ls_0);
            for (l_index_40 = 0; l_index_40 < Bars; l_index_40++)
            {
                ld_12 = 0;
                for (l_index_36 = l_index_40; l_index_36 < NumBars + l_index_40; l_index_36++)
                    ld_12 += (High[l_index_36] + Low[l_index_36]) / 2.0;
                ld_20 = ld_12 / NumBars;
                ld_12 = 0;
                for (l_index_36 = l_index_40; l_index_36 < NumBars + l_index_40; l_index_36++)
                    ld_12 += High[l_index_36] - Low[l_index_36];
        ...
        [Parameter("NumBars", DefaultValue = 5)]
        ...
        public IndicatorDataSeries g_ibuf_80_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries g_ibuf_92_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries g_ibuf_84_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries g_ibuf_88_AlgoOutputDataSeries { get; set; }




        int indicator_buffers = 4;
        int indicator_color1 = Black;
        int indicator_color2 = Black;
        int indicator_color3 = Black;
        int indicator_color4 = Black;
        ...
        Mq4Double indicator_level1 = 0;
        Mq4Double indicator_level2 = 8;
        Mq4Double indicator_level3 = 6;
        Mq4Double indicator_level4 = -6;
        Mq4Double indicator_level5 = -8;


        private Mq4OutputDataSeries g_ibuf_80;
        private Mq4OutputDataSeries g_ibuf_92;
        private Mq4OutputDataSeries g_ibuf_84;
        private Mq4OutputDataSeries g_ibuf_88;
        ...
        {
            if (g_ibuf_80_AlgoOutputDataSeries == null)
                g_ibuf_80_AlgoOutputDataSeries = CreateDataSeries();
            g_ibuf_80 = new Mq4OutputDataSeries(this, g_ibuf_80_AlgoOutputDataSeries, ChartObjects, 12, 0, () => CreateDataSeries(), 1, Colors.Black);
            AllBuffers.Add(g_ibuf_80);
            if (g_ibuf_92_AlgoOutputDataSeries == null)
                g_ibuf_92_AlgoOutputDataSeries = CreateDataSeries();
            g_ibuf_92 = new Mq4OutputDataSeries(this, g_ibuf_92_AlgoOutputDataSeries, ChartObjects, 12, 1, () => CreateDataSeries(), 1, Colors.Black);
            AllBuffers.Add(g_ibuf_92);
            if (g_ibuf_84_AlgoOutputDataSeries == null)
                g_ibuf_84_AlgoOutputDataSeries = CreateDataSeries();
            g_ibuf_84 = new Mq4OutputDataSeries(this, g_ibuf_84_AlgoOutputDataSeries, ChartObjects, 12, 2, () => CreateDataSeries(), 1, Colors.Black);
            AllBuffers.Add(g_ibuf_84);
            if (g_ibuf_88_AlgoOutputDataSeries == null)
                g_ibuf_88_AlgoOutputDataSeries = CreateDataSeries();
            g_ibuf_88 = new Mq4OutputDataSeries(this, g_ibuf_88_AlgoOutputDataSeries, ChartObjects, 12, 3, () => CreateDataSeries(), 1, Colors.Black);
            AllBuffers.Add(g_ibuf_88);

            AllOutputDataSeries.Add(g_ibuf_80_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(g_ibuf_92_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(g_ibuf_84_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(g_ibuf_88_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                g_ibuf_80.SetCurrentIndex(index);
                g_ibuf_92.SetCurrentIndex(index);
                g_ibuf_84.SetCurrentIndex(index);
                g_ibuf_88.SetCurrentIndex(index);
...
//int FILE_BIN = 8;
        ...
        {
            return new Mq4Double(GetPropertyValue<int>(trade, _ => _.Id, _ => _.Id) + (int)100000000.0);
        }
