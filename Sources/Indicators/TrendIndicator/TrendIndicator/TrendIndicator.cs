        ...
        public override void Calculate(int index)
        {
            ...
            else
            {
                if (index < 7)
                    ...
                    Result[index] = (Alpha - Alpha * Alpha / 4) * Source[index] + Alpha * Alpha * Source[index - 1] / 2 - (Alpha - 0.75 * Alpha * Alpha) * Source[index - 2] + 2 * (1 - Alpha) * Result[index - 1] - (1 - Alpha) * (1 - Alpha) * Result[index - 2];
