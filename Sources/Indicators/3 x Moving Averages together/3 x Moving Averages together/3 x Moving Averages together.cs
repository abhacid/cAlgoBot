...
namespace cAlgo.Indicators
{
    ...
    public class Custom3MovingAverageIndicator : Indicator
    {
        ...
        Mq4Double Mq4Start()
        {
            ...
            Mq4Double limit = 0;
            if (Bars <= MA_Period_0 || Bars <= MA_Period_1 || Bars <= MA_Period_2)
                return 0;
            ...
            for (i = 0; i < limit; i++)
            {
                ...
                ExtMapBuffer2[i] = iMA(NULL, 0, MA_Period_2, MA_Shift, MA_Method, Applied_Price, i);
            }
            return 0;
            return 0;
        }
        ...
        [Parameter("MA_Period_2", DefaultValue = 50)]
        public double MA_Period_2_parameter { get; set; }
        bool _MA_Period_2Got;
        Mq4Double MA_Period_2_backfield;
        Mq4Double MA_Period_2
        {
            get
            {
                if (!_MA_Period_2Got)
                    MA_Period_2_backfield = MA_Period_2_parameter;
                return MA_Period_2_backfield;
            }
            set { MA_Period_2_backfield = value; }
        }
        ...
        protected override void Initialize()
        {
            ...
            ExtMapBuffer2 = new Mq4OutputDataSeries(this, ExtMapBuffer2_AlgoOutputDataSeries, _closeExtremums, ChartObjects, 0, 2, () => CreateDataSeries(), 1, Colors.Red);
