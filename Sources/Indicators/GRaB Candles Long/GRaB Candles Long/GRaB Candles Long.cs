    ...
    public class MTFCandles_Indicator : Indicator
    {
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (i = Bars - 1 - IndicatorCounted(); i >= 0; i--)
            {
                ...
                {
                    LongWickUp[shift2] = high;
                    LongCandleUp[shift2] = bodyHigh;
                    LongWickDown[shift2] = low;
                    LongCandleDown[shift2] = bodyLow;
                }
                else if (open >= close && close > EMA_H[i])
                {
                    LongWickUp[shift2] = low;
                    LongCandleUp[shift2] = bodyLow;
                    LongWickDown[shift2] = high;
                    LongCandleDown[shift2] = bodyHigh;
                }
            }
        ...
        public IndicatorDataSeries LongWickUp_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries LongWickDown_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries LongCandleUp_AlgoOutputDataSeries { get; set; }
        public IndicatorDataSeries LongCandleDown_AlgoOutputDataSeries { get; set; }
        ...
        int indicator_color1 = Chartreuse;
        int indicator_color2 = Green;
        int indicator_color3 = Chartreuse;
        int indicator_color4 = Green;
        ...
        private Mq4OutputDataSeries LongWickUp;
        private Mq4OutputDataSeries LongWickDown;
        private Mq4OutputDataSeries LongCandleUp;
        private Mq4OutputDataSeries LongCandleDown;
        ...
        {
            if (LongWickUp_AlgoOutputDataSeries == null)
                LongWickUp_AlgoOutputDataSeries = CreateDataSeries();
            LongWickUp = new Mq4OutputDataSeries(this, LongWickUp_AlgoOutputDataSeries, ChartObjects, 2, 0, () => CreateDataSeries(), 1, Colors.Chartreuse);
            AllBuffers.Add(LongWickUp);
            if (LongWickDown_AlgoOutputDataSeries == null)
                LongWickDown_AlgoOutputDataSeries = CreateDataSeries();
            LongWickDown = new Mq4OutputDataSeries(this, LongWickDown_AlgoOutputDataSeries, ChartObjects, 2, 1, () => CreateDataSeries(), 1, Colors.Green);
            AllBuffers.Add(LongWickDown);
            if (LongCandleUp_AlgoOutputDataSeries == null)
                LongCandleUp_AlgoOutputDataSeries = CreateDataSeries();
            LongCandleUp = new Mq4OutputDataSeries(this, LongCandleUp_AlgoOutputDataSeries, ChartObjects, 2, 2, () => CreateDataSeries(), 1, Colors.Chartreuse);
            AllBuffers.Add(LongCandleUp);
            if (LongCandleDown_AlgoOutputDataSeries == null)
                LongCandleDown_AlgoOutputDataSeries = CreateDataSeries();
            LongCandleDown = new Mq4OutputDataSeries(this, LongCandleDown_AlgoOutputDataSeries, ChartObjects, 2, 3, () => CreateDataSeries(), 1, Colors.Green);
            AllBuffers.Add(LongCandleDown);
            ...
            AllOutputDataSeries.Add(LongWickUp_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(LongWickDown_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(LongCandleUp_AlgoOutputDataSeries);
            AllOutputDataSeries.Add(LongCandleDown_AlgoOutputDataSeries);
        ...
        public override void Calculate(int index)
        {
            ...
            {
                _currentIndex = index;
                LongWickUp.SetCurrentIndex(index);
                LongWickDown.SetCurrentIndex(index);
                LongCandleUp.SetCurrentIndex(index);
                LongCandleDown.SetCurrentIndex(index);
