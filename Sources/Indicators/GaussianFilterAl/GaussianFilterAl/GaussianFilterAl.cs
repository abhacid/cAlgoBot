        ...
        public override void Calculate(int index)
        {
            ...
            switch (Poles)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    Result[index] -= 3 * Math.Pow(_coeff, 2.0) * Result[index - 2] - Math.Pow(_coeff, 3.0) * Result[index - 3];
                    break;
                case 4:
                    Result[index] -= 6 * Math.Pow(_coeff, 2.0) * Result[index - 2] - 4 * Math.Pow(_coeff, 3.0) * Result[index - 3] + Math.Pow(_coeff, 4.0) * Result[index - 4];
                    break;
            }
        }
    }
