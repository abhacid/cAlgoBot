...
namespace cAlgo.Indicators
{
    ...
    public class ConvertedIndicator : Indicator
    {
        ...
        Mq4Double LSMAFunc(Mq4Double Rperiod, Mq4Double shift)
        {
            Mq4Double wt = 0;
            Mq4Double tmp = 0;
            Mq4Double lengthvar = 0;
            Mq4Double length = 0;
            Mq4Double sum = 0;
            Mq4Double i;
        ...
        Mq4Double Mq4Start()
        {
            ...
            for (i = limit; i >= 0; i--)
            {
                if (MAType == 4)
                {
                    MA_Cur = LSMAFunc(MAPeriod, i);
                    MA_Prev = LSMAFunc(MAPeriod, i + 1);
                }
                else
                {
        ...
        [Parameter("MAPeriod", DefaultValue = 21)]
        public int MAPeriod_parameter { get; set; }
        bool _MAPeriodGot;
        Mq4Double MAPeriod_backfield;
        Mq4Double MAPeriod
        {
            get
            {
                if (!_MAPeriodGot)
                    MAPeriod_backfield = MAPeriod_parameter;
                return MAPeriod_backfield;
            }
            set { MAPeriod_backfield = value; }
        }

        [Parameter("MAType", DefaultValue = 1)]
        public int MAType_parameter { get; set; }
        bool _MATypeGot;
        Mq4Double MAType_backfield;
        Mq4Double MAType
        {
            get
            {
                if (!_MATypeGot)
                    MAType_backfield = MAType_parameter;
                return MAType_backfield;
            }
            set { MAType_backfield = value; }
        }



        [Output("ExtMapBuffer3", Color = Colors.Pink, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer3_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer2", Color = Colors.Magenta, PlotType = PlotType.DiscontinuousLine)]
        public IndicatorDataSeries ExtMapBuffer2_AlgoOutputDataSeries { get; set; }
        [Output("ExtMapBuffer1", Color = Colors.OrangeRed, PlotType = PlotType.DiscontinuousLine)]
        ...
        int indicator_buffers = 3;
        int indicator_color1 = Yellow;
        int indicator_color2 = Magenta;
        int indicator_color3 = OrangeRed;
        ...
        protected override void Initialize()
        {
            ...
            ExtMapBuffer3 = new Mq4OutputDataSeries(this, ExtMapBuffer3_AlgoOutputDataSeries, ChartObjects, 0, 0, () => CreateDataSeries(), 2, Colors.Pink);
            ...
            ExtMapBuffer2 = new Mq4OutputDataSeries(this, ExtMapBuffer2_AlgoOutputDataSeries, ChartObjects, 0, 1, () => CreateDataSeries(), 2, Colors.Magenta);
            ...
            ExtMapBuffer1 = new Mq4OutputDataSeries(this, ExtMapBuffer1_AlgoOutputDataSeries, ChartObjects, 0, 2, () => CreateDataSeries(), 2, Colors.OrangeRed);
