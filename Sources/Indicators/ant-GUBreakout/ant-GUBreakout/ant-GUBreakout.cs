...
namespace cAlgo.Indicators
{
    ...
    public class ConvertedIndicator : Indicator
    {
        void Mq4Init()
        {
            Mq4Double l_count_0 = 0;
            for (l_count_0 = 0; l_count_0 < day_number; l_count_0++)
            {
                Buat_ObjFunc("GUB2" + indi_number + l_count_0, boxcolor1);
                Buat_GarisFunc("GUB0" + indi_number + l_count_0, linecolor);
                Buat_GarisFunc("GUB1" + indi_number + l_count_0, linecolor);
                if (offset > 0)
                    Buat_ObjFunc("GUB3" + indi_number + l_count_0, boxcolor2);
            }
            return;
        }
        void deinitFunc()
        {
            ...
            for (l_count_0 = 0; l_count_0 < day_number; l_count_0++)
            {
                ...
                if (offset > 0)
                    ObjectDelete("GUB3" + indi_number + l_count_0);
        ...
        void Buat_ObjFunc(Mq4String a_name_0, Mq4Double a_color_8)
        {
        ...
        void Buat_GarisFunc(Mq4String a_name_0, Mq4Double a_color_8)
        {
        ...
        void Tulis_LabelFunc(Mq4String a_name_0, Mq4String a_text_8, Mq4Double ad_16, Mq4Double a_color_24, Mq4Double a_datetime_28)
        {
            if (ObjectFind(a_name_0) == 1)
                ObjectMove(a_name_0, 0, a_datetime_28, ad_16);
            else
                ObjectCreate(a_name_0, OBJ_TEXT, 0, a_datetime_28, ad_16);
        ...
        void SetTextFunc(Mq4Double ai_0, Mq4String as_4, Mq4String as_12, Mq4String as_20)
        {
            Mq4Double li_40 = 0;
            Mq4Double li_36 = 0;
            Mq4Double li_32 = 0;
            Mq4Double li_28 = 0;
            Mq4Double ld_76 = 0;
            Mq4String ls_unused_72 = "";
            Mq4Double ld_68 = 0;
            Mq4Double ld_60 = 0;
            Mq4Double ld_52 = 0;
            Mq4Double l_shift_48 = 0;
            Mq4Double l_shift_44 = 0;
            ...
            li_28 = StrToTime(TimeToStr(ai_0, TIME_DATE) + " " + "00:00") + 3600 * GMTshift;
            li_32 = StrToTime(TimeToStr(ai_0, TIME_DATE) + " " + as_12) + 3600 * GMTshift;
            li_36 = StrToTime(TimeToStr(ai_0, TIME_DATE) + " " + as_20) + 3600 * GMTshift;
            li_40 = li_28 + 82800;
            if (li_36 < li_32)
            {
            ...
            if (TimeCurrent() >= li_32)
            {
                ...
                if (show_label)
                {
                    Tulis_LabelFunc(as_4 + "hi", "H : [" + DoubleToStr(ld_52, Digits) + "]", ld_68, textcolor, li_32);
                    Tulis_LabelFunc(as_4 + "lo", "L : [" + DoubleToStr(ld_60, Digits) + "]", ld_68, textcolor, li_32 + 12600.0);
                    Tulis_LabelFunc(as_4 + "Range", "R : [" + DoubleToStr((ld_52 - ld_60) / Point, 0) + "]", ld_68, textcolor, li_32 + 25200);
                }
            }
            return;
        }
        void Gambar_ObjFunc(Mq4Double ai_0, Mq4String a_name_4, Mq4String as_12, Mq4String as_20, Mq4Double ai_28)
        {
            Mq4Double l_datetime_44 = 0;
            Mq4Double li_40 = 0;
            Mq4Double li_36 = 0;
            Mq4Double li_32 = 0;
            Mq4Double ld_80 = 0;
            ...
            li_32 = StrToTime(TimeToStr(ai_0, TIME_DATE) + " " + "00:00") + 3600 * GMTshift;
            li_36 = StrToTime(TimeToStr(ai_0, TIME_DATE) + " " + as_12) + 3600 * GMTshift;
            li_40 = StrToTime(TimeToStr(ai_0, TIME_DATE) + " " + as_20) + 3600 * GMTshift;
            l_datetime_44 = li_32 + 82800;
            if (li_40 < li_36)
            {
            ...
            if (TimeCurrent() >= li_36)
            {
                if (TimeCurrent() < li_40)
                    li_40 = Time[0];
                if (TimeCurrent() < l_datetime_44)
                    l_datetime_44 = Time[0];
                l_shift_48 = iBarShift(NULL, 0, li_36);
        ...
        Mq4Double Hari_TradingFunc(Mq4Double ai_0)
        {
            Mq4Double l_minute_20 = 0;
            Mq4Double l_hour_16 = 0;
            Mq4Double li_12 = 0;
            Mq4Double li_8 = 0;
            Mq4Double li_4 = 0;
            li_4 = TimeYear(ai_0);
            li_8 = TimeMonth(ai_0);
            li_12 = TimeDay(ai_0);
            l_hour_16 = TimeHour(ai_0);
            l_minute_20 = TimeMinute(ai_0);
            li_12--;
            if (li_12 == 0)
            {
                li_8--;
                ...
                if (li_8 == 1 || li_8 == 3 || li_8 == 5 || li_8 == 7 || li_8 == 8 || li_8 == 10 || li_8 == 12)
                    li_12 = 31;
                if (li_8 == 2)
                {
                    if (MathMod(li_4, 4) == 0.0)
                        li_12 = 29;
                    else
                        li_12 = 28;
                }
                if (li_8 == 4 || li_8 == 6 || li_8 == 9 || li_8 == 11)
                    li_12 = 30;
            }
            return StrToTime(li_4 + "." + li_8 + "." + li_12 + " " + l_hour_16 + ":" + l_minute_20);
            return 0;
        }
        void TulisFunc(Mq4String a_name_0, Mq4Double a_corner_8, Mq4Double a_y_16, Mq4Double a_x_20, Mq4String a_text_24, Mq4Double a_fontsize_32, Mq4String a_fontname_36, Mq4Double a_color_44)
        {
        ...
        void Mq4Start()
        {
            ...
            Mq4Double l_datetime_0 = 0;
            l_datetime_0 = TimeCurrent();
            if (Period() < PERIOD_H4)
            {
                TulisFunc("ext_lbl", 3, 5, 10, "ant-GUBreakout_V.0.4 by andee", 8, "Arial", SlateGray);
                for (l_count_4 = 0; l_count_4 < day_number; l_count_4++)
                {
                    if (TimeDayOfWeek(l_datetime_0) > 0 && TimeDayOfWeek(l_datetime_0) < 6)
                    {
                        Gambar_ObjFunc(l_datetime_0, "GUB0" + indi_number + l_count_4, Start, End, 0);
                        Gambar_ObjFunc(l_datetime_0, "GUB1" + indi_number + l_count_4, Start, End, 1);
                        Gambar_ObjFunc(l_datetime_0, "GUB2" + indi_number + l_count_4, Start, End, 2);
                        SetTextFunc(l_datetime_0, "txt_" + indi_number + l_count_4, Start, End);
                        if (offset > 0)
                            Gambar_ObjFunc(l_datetime_0, "GUB3" + indi_number + l_count_4, Start, End, 3);
                        l_datetime_0 = Hari_TradingFunc(l_datetime_0);
                    }
                    if (TimeDayOfWeek(l_datetime_0) > 5 || TimeDayOfWeek(l_datetime_0) == 0)
                        l_datetime_0 = Hari_TradingFunc(l_datetime_0);
                }
            }
            return;
        ...
        [Parameter("exp1", DefaultValue = "--- 1.0Change this_ number ---")]
        public string exp1_parameter { get; set; }
        bool _exp1Got;
        Mq4String exp1_backfield;
        Mq4String exp1
        {
            get
            {
                if (!_exp1Got)
                    exp1_backfield = exp1_parameter;
                return exp1_backfield;
            }
            set { exp1_backfield = value; }
        }

        [Parameter("indi_number", DefaultValue = 123)]
        public int indi_number_parameter { get; set; }
        bool _indi_numberGot;
        Mq4Double indi_number_backfield;
        Mq4Double indi_number
        {
            get
            {
                if (!_indi_numberGot)
                    indi_number_backfield = indi_number_parameter;
                return indi_number_backfield;
            }
            set { indi_number_backfield = value; }
        }

        [Parameter("exp2", DefaultValue = "--- 2.0 Time Setting ---")]
        public string exp2_parameter { get; set; }
        bool _exp2Got;
        Mq4String exp2_backfield;
        Mq4String exp2
        {
            get
            {
                if (!_exp2Got)
                    exp2_backfield = exp2_parameter;
                return exp2_backfield;
            }
            set { exp2_backfield = value; }
        }

        [Parameter("GMTshift", DefaultValue = 3)]
        public int GMTshift_parameter { get; set; }
        bool _GMTshiftGot;
        Mq4Double GMTshift_backfield;
        Mq4Double GMTshift
        {
            get
            {
                if (!_GMTshiftGot)
                    GMTshift_backfield = GMTshift_parameter;
                return GMTshift_backfield;
            }
            set { GMTshift_backfield = value; }
        }

        [Parameter("Start", DefaultValue = "14:00")]
        public string Start_parameter { get; set; }
        bool _StartGot;
        Mq4String Start_backfield;
        Mq4String Start
        {
            get
            {
                if (!_StartGot)
                    Start_backfield = Start_parameter;
                return Start_backfield;
            }
            set { Start_backfield = value; }
        }

        [Parameter("End", DefaultValue = "16:00")]
        public string End_parameter { get; set; }
        bool _EndGot;
        Mq4String End_backfield;
        Mq4String End
        {
            get
            {
                if (!_EndGot)
                    End_backfield = End_parameter;
                return End_backfield;
            }
            set { End_backfield = value; }
        }

        [Parameter("exp3", DefaultValue = "--- 3.0 Display Setting ---")]
        public string exp3_parameter { get; set; }
        bool _exp3Got;
        Mq4String exp3_backfield;
        Mq4String exp3
        {
            get
            {
                if (!_exp3Got)
                    exp3_backfield = exp3_parameter;
                return exp3_backfield;
            }
            set { exp3_backfield = value; }
        }

        [Parameter("day_number", DefaultValue = 6)]
        public int day_number_parameter { get; set; }
        bool _day_numberGot;
        Mq4Double day_number_backfield;
        Mq4Double day_number
        {
            get
            {
                if (!_day_numberGot)
                    day_number_backfield = day_number_parameter;
                return day_number_backfield;
            }
            set { day_number_backfield = value; }
        }

        [Parameter("offset", DefaultValue = 10)]
        public int offset_parameter { get; set; }
        bool _offsetGot;
        Mq4Double offset_backfield;
        Mq4Double offset
        {
            get
            {
                if (!_offsetGot)
                    offset_backfield = offset_parameter;
                return offset_backfield;
            }
            set { offset_backfield = value; }
        }

        [Parameter("exp4", DefaultValue = "--- 4.0 Color Setting ---")]
        public string exp4_parameter { get; set; }
        bool _exp4Got;
        Mq4String exp4_backfield;
        Mq4String exp4
        {
            get
            {
                if (!_exp4Got)
                    exp4_backfield = exp4_parameter;
                return exp4_backfield;
            }
            set { exp4_backfield = value; }
        }

        [Parameter("linecolor", DefaultValue = Silver)]
        public int linecolor_parameter { get; set; }
        bool _linecolorGot;
        Mq4Double linecolor_backfield;
        Mq4Double linecolor
        {
            get
            {
                if (!_linecolorGot)
                    linecolor_backfield = linecolor_parameter;
                return linecolor_backfield;
            }
            set { linecolor_backfield = value; }
        }

        [Parameter("textcolor", DefaultValue = Silver)]
        ...
        [Parameter("boxcolor1", DefaultValue = MidnightBlue)]
        public int boxcolor1_parameter { get; set; }
        bool _boxcolor1Got;
        Mq4Double boxcolor1_backfield;
        Mq4Double boxcolor1
        {
            get
            {
                if (!_boxcolor1Got)
                    boxcolor1_backfield = boxcolor1_parameter;
                return boxcolor1_backfield;
            }
            set { boxcolor1_backfield = value; }
        }

        [Parameter("boxcolor2", DefaultValue = MidnightBlue)]
        public int boxcolor2_parameter { get; set; }
        bool _boxcolor2Got;
        Mq4Double boxcolor2_backfield;
        Mq4Double boxcolor2
        {
            get
            {
                if (!_boxcolor2Got)
                    boxcolor2_backfield = boxcolor2_parameter;
                return boxcolor2_backfield;
            }
            set { boxcolor2_backfield = value; }
        }

        [Parameter("exp5", DefaultValue = "--- 5.0 Others :) ---")]
        public string exp5_parameter { get; set; }
        bool _exp5Got;
        Mq4String exp5_backfield;
        Mq4String exp5
        {
            get
            {
                if (!_exp5Got)
                    exp5_backfield = exp5_parameter;
                return exp5_backfield;
            }
            set { exp5_backfield = value; }
        }

        [Parameter("show_label", DefaultValue = TRUE)]
        public bool show_label_parameter { get; set; }
        bool _show_labelGot;
        Mq4Double show_label_backfield;
        Mq4Double show_label
        {
            get
            {
                if (!_show_labelGot)
                    show_label_backfield = show_label_parameter;
                return show_label_backfield;
            }
            set { show_label_backfield = value; }
        }
