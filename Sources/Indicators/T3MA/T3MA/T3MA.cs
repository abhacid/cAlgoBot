...
namespace cAlgo.Indicators
{
    ...
    public class T3MA : Indicator
    {
        ...
        public override void Calculate(int index)
        {
			...
			b = Volume_Factor;
			b2 = Math.Pow(b, 2); // Volume Factor Squared
        	b3 = Math.Pow(b, 3); // Volume Factor Cubed
            ...
            Result[index] = c1*ema6.Result[index] 
            			+ c2*ema5.Result[index]
            			+ c3*ema4.Result[index] 
            			+ c4*ema3.Result[index];
        }
    }
}